    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            }
            {
                ...
                int result = proxy.insertdetails(txtfname.Text, txtlname.Text, txtuname.Text, txtpassword.Text, Convert.ToInt32(txtage.Text), txtuniqueid.Text, txtphone.Text, txtemail.Text);
